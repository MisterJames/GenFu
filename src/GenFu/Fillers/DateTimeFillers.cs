...
public class DateTimeFiller : PropertyFiller<DateTime>
{
    ...
    public DateTimeFiller() : base(typeof(object), "*", true) { }


    public override object GetValue(object instance) => GetRandomDate();
...
public class DateTimeOffsetFiller : PropertyFiller<DateTimeOffset>
{
    ...
    public DateTimeOffsetFiller() : base(typeof(object), "*", true) { }

    public override object GetValue(object instance)
     => new DateTimeOffset(new DateTimeFiller().GetRandomDate());
}
...
public class BirthDateFiller : PropertyFiller<DateTime>
{
    ...
    public override object GetValue(object instance)
     => CalendarDate.Date(DateTime.Today.AddYears(-110), DateTime.Today);
}
